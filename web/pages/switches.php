...
<?php
  ...
  <table class="table">
  <?php
  $sql = "(SELECT a.id, a.name, a.model, a.ip, a.distro_port, a.latency_ms, b.name AS corename FROM switches a JOIN switches b WHERE a.ip IS NOT NULL AND a.distro_id = b.id)
  UNION (SELECT a.id, a.name, a.model, a.ip, a.distro_port, a.latency_ms, '' as dummy_column FROM switches a WHERE a.ip IS NOT NULL AND distro_id IS NULL)";
  echo '<tr class="info">';
  echo "<td><b>Name</b></td>";
