...
sudo mkdir -p "/lcs/"
apt-get -y install libnet-snmp-perl unzip libstring-random-perl libnetaddr-ip-perl libnet-netmask-perl isc-dhcp-server bind9 lamp-server^ libnet-telnet-cisco-perl libnet-telnet-perl tftpd-hpa libnet-oping-perl librrds-perl rrdtool snmp-mibs-downloader
cd "/lcs"
